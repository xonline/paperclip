---
name: seo
description: Audit, plan, and implement SEO improvements across technical SEO, on-page optimization, structured data, Core Web Vitals, content strategy, content briefs, and backlink opportunities. Use when the user wants better search visibility, SEO remediation, schema markup, sitemap/robots work, keyword mapping, content gap analysis, or a full end-to-end SEO workflow for a site or target keyword.
origin: ECC
---
...
### Prioritise By
- Search volume (high)
- Keyword difficulty (prefer <40 KD)
- Business value (high)
...
3. **Target word count** (based on SERP analysis of top 5 results)
4. **Outline** — H1, H2s, H3s
5. **Questions to answer** (People Also Ask)
6. **Internal links** to include
7. **Competitor analysis** — what to beat and your unique angle
...
Internal Links:
Competitor Analysis: | Competitor | Word Count | Unique Angle |
